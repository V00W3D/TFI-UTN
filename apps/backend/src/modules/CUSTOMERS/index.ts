 ...
 *
 * @technical
 * dependencies: api, GetPlatesHandler, GetFeaturedPlatesHandler, SearchPlatesHandler, UpsertReviewHandler, CreateCustomerOrderHandler, GetCustomerOrderHistoryHandler, GetAddressesHandler, CreateAddressHandler, UpdateAddressHandler
