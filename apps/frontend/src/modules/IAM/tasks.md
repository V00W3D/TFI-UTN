...
@file tasks.md
@module IAM
@description Seguimiento de tareas y estado del modulo IAM del frontend.
...
@technical
dependencies: planeamiento del modulo IAM frontend, consumido como registro de seguimiento interno
