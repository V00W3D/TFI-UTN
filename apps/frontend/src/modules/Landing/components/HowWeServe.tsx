        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-stretch">
          ...
          >
            <div className="relative z-10">
              <div className="w-20 h-20 bg-qart-accent text-white flex items-center justify-center mb-10 border-4 border-qart-border shadow-[6px_6px_0px_#1A1A1A]">
          ...
          >
            <div className="relative z-10 text-qart-text-inv">
              <div className="w-20 h-20 bg-qart-accent text-white flex items-center justify-center mb-10 border-4 border-qart-border shadow-[6px_6px_0px_rgba(0,0,0,0.3)]">
                <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            ...
            <button className="mt-12 btn-outline w-full text-xl uppercase tracking-widest !bg-qart-bg !text-qart-primary !border-qart-border shadow-[6px_6px_0px_rgba(0,0,0,0.5)]">
              Ver Ubicación
            </button>
          </motion.div>
        </div>
