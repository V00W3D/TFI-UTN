...
export const HOSTING_PROFILE = getEnvVar('VITE_HOSTING_PROFILE', 'standard') as 'standard' | 'local_tailscale' | 'replit';
...
export const BACKEND_URL: string =
  rawBackendUrl !== undefined ? rawBackendUrl : constructedURL;
